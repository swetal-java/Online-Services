								...
								<div class="col-md-12">
									<div class="form-floating">
										<input type="text" class="form-control" id="name" name="sname"
											placeholder="Your Name"> <label for="name">Service Name
											</label>
									</div>
								</div>
								<div class="col-md-12">
									<div class="form-floating">
										<input type="text" class="form-control" id="name" name="sprice"
											placeholder="Your Contact"> <label for="name">Service Price
											</label>
									</div>
								</div>
								<div class="col-md-12">
									<div class="form-floating">
										<input type="text" class="form-control" id="name" name="sduration"
											placeholder="Your Address"> <label for="name">Service Duration
											</label>
									</div>
								</div>
								...
								<div class="col-md-12">
									<div class="form-floating">
										<input type="text" class="form-control" id="email" name="scategory"
											placeholder="Your Email"> <label for="email">Service Category
											</label>
									</div>
								</div>
								<div class="col-12">
