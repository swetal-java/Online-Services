				...
				<div class="navbar-nav me-auto">
					...
					<div class="nav-item dropdown">
						...
						<div class="dropdown-menu fade-up m-0">
							<a href="customer-pending-service.jsp" class="dropdown-item">Pending
								Service</a> <a href="customer-complete-service.jsp"
								class="dropdown-item">Complete Service</a> <a
								href="customer-rejected-service.jsp" class="dropdown-item">Rejected
								Service</a>
						</div>
					</div>
					<div class="nav-item dropdown">
						<a href="#" class="nav-link dropdown-toggle"
							data-bs-toggle="dropdown"><%= c.getName() %></a>
						<div class="dropdown-menu fade-up m-0">
