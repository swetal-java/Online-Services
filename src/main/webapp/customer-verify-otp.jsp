...
<body>
	...
	<div class="container-fluid page-header mb-5 py-5">
		<div class="container">
			<h1 class="display-3 text-white mb-3 animated slideInDown">Verify
				OTP</h1>
							...
							<div class="row g-3">
								<div class="col-md-12">
									<div class="form-floating">
										...
										<input type="hidden" name="otp1" value="<%=otp%>"> <input
											type="text" class="form-control" id="email" name="otp2"
											placeholder="Your Email"> <label for="email">Enter
											OTP </label>
									</div>
								</div>
