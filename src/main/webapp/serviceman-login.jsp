...
<script>
	function chk_email() {
		var f = document.loginform.email.value;
		if (f.trim() == "") {
	...
	function chk_password() {
		var f = document.loginform.password.value;
		if (f.trim() == "") {
...
<body>
	...
	<script>
		...
		function exists_email() {
			...
			var url = "serviceman-login.jsp?val=" + e;
			try {
				request.onreadystatechange = function() {
					if (request.readyState == 4) {
						var val = request.responseText();
						document.getElementById('chkemail').innerHTML = val;
			...
			<div class="row g-12">
				<div class="col-md-8 wow fadeInUp" data-wow-delay="0.1s">
					<div class="bg-light p-5 h-100 d-flex align-items-center">
						...
						<%
						String msg2 = (String) request.getAttribute("passwordmsg");
						%>
						<%
						if (msg2 != null) {
							out.print(msg);
						...
						<form action="ServiceManController" method="post" name="loginform">
							<div class="row g-3">
								<div class="col-md-12">
									<div class="form-floating">
										<input type="email" class="form-control" id="email"
											name="email" onblur="chk_email();" onblur="exists_email()"
											placeholder="Your Email"> <label for="email">Your
											Email</label> <span id="erroremail" style="color: red;"></span> <span
											id="chkemail" style="color: red;"></span>
									</div>
								</div>
								<div class="col-md-12">
									<div class="form-floating">
										<input type="password" class="form-control" id=""
											name="password" onblur="chk_password();"
						...
						<br> <br> <a href="serviceman-forgot-password.jsp">Forgot
							Password ?</a>
					</div>
				</div>
			</div>
