		...
		<div class="container">
			...
			<nav aria-label="breadcrumb animated slideInDown">
				<ol class="breadcrumb text-uppercase">
					...
					<li class="breadcrumb-item text-white active" aria-current="page">Customer
						Login</li>
				</ol>
			</nav>
		</div>
			...
			<div class="row g-12">
				<div class="col-md-8 wow fadeInUp" data-wow-delay="0.1s">
					<div class="bg-light p-5 h-100 d-flex align-items-center">
						...
						<%
						String ermsg = (String) request.getAttribute("passwordmsg");
						%>
						<%
						if (ermsg != null) {
							out.print(ermsg);
								...
								<div class="col-md-12">
									<div class="form-floating">
										<input type="password" class="form-control" id="name"
											name="password" placeholder="Your Password"> <label
											for="name">Your Password</label>
									</div>
								</div>
						...
						<br> <br> <a href="customer-forgot-password.jsp">Forgot
							Password ?</a>
					</div>
				</div>
			</div>
