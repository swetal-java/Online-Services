								...
								<div class="col-md-12">
									<div class="form-floating">
										<input type="hidden" class="form-control" id="name" name="id"
											value="<%=s.getId()%>" placeholder="Your Name"> <label
											for="name"></label>
									</div>
								</div>
								<div class="col-md-12">
									<div class="form-floating">
										<input type="text" class="form-control" id="name" name="name"
											value="<%=s.getName()%>" placeholder="Your Name"> <label
								...
								<div class="col-md-12">
									<div class="form-floating">
										<input type="text" class="form-control" id="name"
											name="contact" value="<%=s.getContact()%>"
											placeholder="Your Contact"> <label for="name">Your
											Contact</label>
									</div>
								</div>
								<div class="col-md-12">
									<div class="form-floating">
										<input type="text" class="form-control" id="name"
											name="address" value="<%=s.getAddress()%>"
											placeholder="Your Address"> <label for="name">Your
											Address</label>
									</div>
								</div>
