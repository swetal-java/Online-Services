...
public class Servicess {
	public void sendMail(String emailid,int num){
		final String username  = "onlineservicec1990@gmail.com";
		final String password  = "ktgywcbmklkdpaix";
...
//		587
	...
	public void sendConfrmationMail(String emailid){
		final String username  = "onlineservicec1990@gmail.com";
		final String password  = "ktgywcbmklkdpaix";
...
//		587
		...
		try {
			...
			message.setRecipients(Message.RecipientType.TO,InternetAddress.parse(emailid));//to mail address.
			System.out.println("4");
			message.setSubject("Confirmation Services");
			message.setText("Your Service has been Confirmed..");
			System.out.println("5");
			Transport.send(message);
			System.out.println("Done");
